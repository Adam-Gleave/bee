...
fn new_invalid_index_length_more_than_max() {
    assert!(matches!(
        IndexationPayload::new(0, rand_bytes(65), [0x42, 0xff, 0x84, 0xa2, 0x42, 0xff, 0x84, 0xa2].to_vec()),
...
fn new_invalid_data_length_more_than_max() {
    assert!(matches!(
        IndexationPayload::new(0, rand_bytes(32), [0u8; MESSAGE_LENGTH_MAX + 42].to_vec()),
